...
const OwnerDetails = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-customGreen to-customWhite py-12 px-4 sm:px-6 lg:px-8 font-light">
...
const Header = () => (
  ...
  >
    <h1 className="text-5xl sm:text-6xl md:text-7xl font-extralight text-customGreen mb-4 tracking-wider">
      LET'S START A <span className="text-customAccent">NEW PROJECT</span>
    </h1>
    <p className="text-xl text-customGreen max-w-2xl mx-auto font-light">
...
const ContactInfo = () => (
  <motion.div
    className="bg-customWhite bg-opacity-80 backdrop-filter backdrop-blur-lg rounded-lg shadow-xl p-8"
    initial={{ opacity: 0, x: -100 }}
    animate={{ opacity: 1, x: 0 }}
    transition={{ duration: 0.8 }}
  >
    <h2 className="text-3xl font-light mb-6 text-customGreen">Contact Information</h2>
...
const ContactItem = ({ icon, text }) => (
  <div className="flex items-center text-customGreen">
    <svg className="w-6 h-6 mr-3 text-customAccent" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
const ContactForm = () => {
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 0.8 }}
    >
      <h2 className="text-3xl font-light mb-6 text-customGreen">Send Us a Message</h2>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          className="w-full bg-customGreen text-customWhite py-3 px-4 rounded-md hover:bg-opacity-90 transition duration-300 ease-in-out transform hover:scale-105"
        >
          Send Message
        </button>
      </form>
  ...
  <div>
    {textarea ? (
      <textarea
        ...
        value={value}
        onChange={onChange}
        className={`w-full p-3 border rounded-md bg-customWhite bg-opacity-50 ${error ? 'border-red-500' : 'border-customGreen border-opacity-50'}`}
        rows="4"
      />
    ) : (
      <input
...
const Map = () => {
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 0.8 }}
    >
      <h2 className="text-3xl font-light mb-6 text-customGreen text-center">Our Location</h2>
