...
const DisplayHomes = () => {
  ...
  return (
    <div className=" mx-auto  px-24 py-16 bg-gradient-to-b from-customWhite to-white">
      <motion.h1
        className="text-5xl font-bold mb-12 text-center bg-clip-text text-transparent bg-gradient-to-r from-customGreen to-green-700"
